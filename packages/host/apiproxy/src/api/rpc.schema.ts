...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('file-not-directory'), message: z.string(), details: z.object({ path: z.string() }) }),
  ...
  z.object({ code: z.literal('file-write-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-outside-workspace'), message: z.string(), details: z.object({ path: z.string() }) }),
