 ...
 * registers the Files tab into a real SlotRegistry ring. Skips when dist/ is
 * not built (`pnpm --filter @deepseek-ai/dsh-client-ui-files bundle`).
 */
...
describe('tsdown client artifact', () => {
  ...
  it('the node half apply is a harmless no-op', () => {
