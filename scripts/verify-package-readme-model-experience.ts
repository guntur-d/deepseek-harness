...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-files': { kind: 'indirect', reason: 'The panel edits the same workspace files the model-facing fs tools read and write (shared ctx.fs seam); it registers no prompt section, tool schema, or session event.' },
